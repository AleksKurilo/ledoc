...
public class EmployeeController {
    ...
    public Iterable<GetEmployeeDTO> getAllEmployees(@CurrentUser UserDetails currentUser,
        ...
        return employeeService.getAllByCustomer(currentUser, searchString, predicate, pageable, isNew, isArchived);
    }
    ...
    public ResponseEntity<StreamingResponseBody> exportEmployees(@CurrentUser UserDetails currentUser,
        ...
        return ResponseEntity.ok()
                ...
                .body(outputStream -> employeeService.exportToExcel(currentUser, searchString, predicate, isNew, isArchived).write(outputStream));
    }
