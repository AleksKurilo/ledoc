...
public class LogsController {
    ...
    public LogsDTO getEmployeeLogs(@PathVariable Long employeeId,
                                   @QuerydslPredicate(root = EmployeeLog.class) Predicate predicate) {
        return employeeLogService.getAllLogsByTargetId(employeeId, predicate);
    }
