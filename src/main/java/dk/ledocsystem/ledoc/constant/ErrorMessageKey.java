package dk.ledocsystem.ledoc.constant;
...
public final class ErrorMessageKey {
    ...
    public static final String CUSTOMER_NAME_IS_ALREADY_IN_USE = "UniqueName.dk.ledocsystem.ledoc.dto.customer.CustomerCreateDTO.name";
    public static final String CVR_IS_ALREADY_IN_USE = "UniqueCVR.dk.ledocsystem.ledoc.dto.customer.CustomerCreateDTO.cvr";
