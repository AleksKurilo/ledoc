...
update main.documents set responsible_id = 1 where main.documents.responsible_id is null;
alter table main.documents alter column responsible_id set not null;