...
class EquipmentServiceImpl implements EquipmentService {
    ...
    public GetEquipmentDTO updateEquipment(@NonNull EquipmentDTO equipmentDTO, UserDetails creatorDetails) {
        Customer customer = employeeRepository.findByUsername(creatorDetails.getUsername())
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<EquipmentPreviewDTO> getPreviewDtoById(@NonNull Long equipmentId) {
